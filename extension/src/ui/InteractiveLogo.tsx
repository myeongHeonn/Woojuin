// ⚠️ 웹앱 frontend/src/components/ui/InteractiveLogo.tsx 의 복사본이다.
// 익스텐션은 별도 빌드라 코드를 공유할 수단이 없어(공용 패키지 없음) 그대로 옮겼다.
// 원본이 바뀌면 여기도 같이 옮겨야 한다 — 로고 모양·움직임이 갈리면 안 된다.
// 의존성은 react 뿐이고 Tailwind·에셋을 쓰지 않아 수정 없이 그대로 동작한다.
