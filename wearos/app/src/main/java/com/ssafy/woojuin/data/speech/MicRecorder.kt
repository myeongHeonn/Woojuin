...
class MicRecorder(
    ...
    private fun pump(record: AudioRecord, collected: ByteArrayOutputStream) {
        ...
        while (!cancelled && elapsedMs < MAX_DURATION_MS) {
