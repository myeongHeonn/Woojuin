...
object WoojuinColor {
    ...
    val SidebarBlack = Color(0xFF0E0F13)
    val Surface = Color(0xFF17181D)
    val SurfaceActive = Color(0xFF1E2027)
    val SurfaceRaised = Color(0xFF262932)
    val Border = Color(0xFF23252D)

    val TextPrimary = Color(0xFFE8EAEE)
    val TextSecondary = Color(0xFF9AA0AC)
    val TextMuted = Color(0xFF5A6070)
