...
<!-- 스크린샷 자리 ①: 서비스 대표 이미지(성좌 뷰 전체 화면). 파일을 넣고 아래 주석을 풀어주세요.
<div align="center">
  <img src="docs/images/hero-universe.png" alt="우주인 성좌 뷰" width="900" />
</div>
-->
...
<!-- 스크린샷 자리 ②: 저장 통로(확장 팝업 / 모바일 공유 시트 / 슬래시 명령) 콜라주
![저장 통로](docs/images/save-anywhere.png)
-->
...
| 성좌 | 라이브러리 | 지도 |
| --- | --- | --- |
| ![성좌](docs/images/view-universe.png) | ![라이브러리](docs/images/view-library.png) | ![지도](docs/images/view-map.png) |
-->
...
<!-- 스크린샷 자리 ④: AI 검색 결과 화면
![AI 검색](docs/images/ai-search.png)
-->
...
<!-- 스크린샷 자리 ⑤: 워크스페이스 멤버 / 초대 화면
![워크스페이스](docs/images/workspace.png)
-->
